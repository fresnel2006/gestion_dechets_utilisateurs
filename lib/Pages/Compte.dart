...
class _ComptePageState extends State<ComptePage> {
  String nom="TRAORE ANGE FRESNEL";
  String numero="0150161468";
  String mot_de_passe="fresco2.0";
  @override
...
Icon(Icons.edit,color: Colors.green,),
                    ...
                    nom.length>15?Text(nom.substring(0,15)+"...",style: TextStyle(fontFamily: "Poppins"),):Text(nom,style: TextStyle(fontFamily: "Poppins"))
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: MediaQuery.of(context).size.width *0.04,),
                      mot_de_passe.length>10?Text(mot_de_passe.substring(0,10)+"...",style: TextStyle(fontFamily: "Poppins")):Text(mot_de_passe,style: TextStyle(fontFamily: "Poppins"))
                  ],),),
                GestureDetector(
                    onTap: (){
